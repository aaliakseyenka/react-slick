...
var Slider =
  ...
  (function(_React$Component) {
    ...
    function Slider(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "onInnerResize", function(
        rect
      ) {
        var responsive = _this.props.responsive;

        if (responsive && rect) {
          var width = rect.width; // find next effective breakpoint (without mutating the original responsive array)

          var nextBreakpoint = responsive
            .map(function(resp) {
